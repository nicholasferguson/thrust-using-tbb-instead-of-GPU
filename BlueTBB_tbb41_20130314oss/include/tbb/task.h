...
private:
    ...
    // TODO: use atomic operations (may_have_children consulted concurrently during context state propagation)
    //       how does this synchronise anyway, because this seems to be consulted outside of list locking and epoch handling?
    __TBB_atomic uintptr_t my_state;
...
private:
    ...
    template <typename T>
    void propagate_task_group_state ( T task_group_context::*mptr_state, task_group_context& src, T new_state, bool for_cancellation );
