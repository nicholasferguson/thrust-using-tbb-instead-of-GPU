...
// Originally little-endian, e.g., |1234| for aligned storage of 0x04030201.
// For correctness, any |xx34|12xx| or |4321|8765| is irrelevant.
// For performance, try "#define __TBB_BIG_ENDIAN 1" for (any remaining use of) the latter.
