...
#elif __bgq__
    #error // __bgq__ => __powerpc64__
#else
    #define __TBB_WORDSIZE 4
#endif

// The setting of __TBB_BIG_ENDIAN is left up to tbb_machine.h.
// Originally big-endian.
// Little-endian could be just an address manipulation (compatibility with TBB not verified), or normal little-endian (on more recent systems).
// Embedded PowerPC systems may support page-specific endianness, but then the "other" endianness must not be used for TBB.
