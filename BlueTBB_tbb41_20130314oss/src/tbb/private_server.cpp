...
class private_worker: no_copy {
    ...
    #if !USING_AVOID_64K_ALIASING
    __TBB_ATTRIBUTE_UNUSED // smallest impact
    #endif
    ;
...
class padded_private_worker: public private_worker {
    char pad[cache_line_size - sizeof(private_worker)%cache_line_size] __TBB_ATTRIBUTE_UNUSED;
public:
